...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements IOrderService {
    ...
    public boolean submit(String userId, Order order) {
        ...
        SendStatus sendStatus = orderCancelTemplate.syncSend(RocketMqConstant.ORDER_CANCEL_TOPIC, new GenericMessage<>(order.getOrderId()), RocketMqConstant.TIMEOUT, RocketMqConstant.CANCEL_ORDER_DELAY_LEVEL).getSendStatus();
